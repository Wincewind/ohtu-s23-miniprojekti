...
class TestReferenceService(unittest.TestCase):
    ...
    def test_add_valid_book(self):
        self.assertTrue(self.ref_ser.add_book(authors='Garwin, Robert',
                                              title='Clean Code: A Handbook of Agile Software Craftsmanship',
                                              year=2008, publisher='Prentice Hall', publisher_address='Bakerstreet 123',
                                              ref_type="book"))

    def test_add_book_with_invalid_year(self):
        self.assertFalse(self.ref_ser.add_book(authors='Garwin, Robert',
                                              title='Clean Code: A Handbook of Agile Software Craftsmanship',
                                              year=1000, publisher='Prentice Hall', publisher_address='Bakerstreet 123'))
    ...
    def test_add_book_with_invalid_author(self):
        self.assertFalse(self.ref_ser.add_book(authors=None,
                                              title='Clean Code: A Handbook of Agile Software Craftsmanship',
                                              year=2008, publisher='Prentice Hall', publisher_address='Bakerstreet 123'))
